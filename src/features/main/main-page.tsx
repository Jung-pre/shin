...
import type { HeroQuickBarMessages, TypographySectionMessages } from "@/shared/i18n/messages";
...
export const MainPage = ({ locale, heroQuickBar, typographySection }: MainPageProps) => {
